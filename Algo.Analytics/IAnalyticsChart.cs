...
public interface IAnalyticsChart<X, Y, Z>
{
	...
	void Append(IEnumerable<X> xValues, IEnumerable<Y> yValues, ChartIndicatorDrawStyles style = ChartIndicatorDrawStyles.Line, Color? color = default);
	...
	/// <param name="style"><see cref="ChartIndicatorDrawStyles"/></param>
	/// <param name="color">Series color.</param>
	void Append(IEnumerable<X> xValues, IEnumerable<Y> yValues, IEnumerable<Z> zValues, ChartIndicatorDrawStyles style = ChartIndicatorDrawStyles.Bubble, Color? color = default);
}