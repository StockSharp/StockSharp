namespace StockSharp.Community
{
	...
	public interface IFileClient
	{
		...
		FileInfoMessage GetFile(long id, Action<long, long> progress = null, Func<bool> cancel = null);
		...
		bool Download(FileInfoMessage data, Action<long, long> progress = null, Func<bool> cancel = null);
		...
		/// <param name="cancel">Cancel callback.</param>
		/// <returns>If the operation was cancelled by <paramref name="cancel"/>, <see langword="false"/> will return.</returns>
		bool DownloadTemp(FileInfoMessage data, Guid operationId, Action<long, long> progress = null, Func<bool> cancel = null);
		...
		/// <param name="progress">Progress callback.</param>
		/// <param name="cancel">Cancel callback.</param>
		void Update(FileInfoMessage data, Action<long, long> progress = null, Func<bool> cancel = null);
		...
		FileInfoMessage Upload(string fileName, byte[] body, bool isPublic, Action<long, long> progress = null, Func<bool> cancel = null);
		...
		/// <param name="cancel">Cancel callback.</param>
		/// <returns>File data. If the operation was cancelled by <paramref name="cancel"/>, <see langword="null"/> will return.</returns>
		Guid? UploadTemp(string fileName, byte[] body, Action<long, long> progress = null, Func<bool> cancel = null);
