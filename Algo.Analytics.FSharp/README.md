...
These scripts are examples for the Hydra analytics feature. Refer to the [documentation](https://doc.stocksharp.com/en/topics/hydra/analytics.html) for more information.
