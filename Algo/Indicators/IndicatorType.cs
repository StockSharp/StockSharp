namespace StockSharp.Algo.Indicators
{
	...
	public class IndicatorType : Equatable<IndicatorType>, IPersistable
	{
		...
		/// <summary>
		/// Create new instance with specified painter.
		/// </summary>
		/// <param name="painter">Indicator painter type to use.</param>
		public IndicatorType WithPainter(Type painter) => new IndicatorType(Indicator, painter);
