    ...
    ITransactionProvider, IScheduledTask, ICustomTypeDescriptor
{
	...
	public Strategy()
	{
		...
		_volume = Param<decimal>(nameof(Volume), 1).SetValidator(new GreaterThanZeroAttribute()).SetDisplay(LocalizedStrings.Volume, LocalizedStrings.StrategyVolume, LocalizedStrings.General);
