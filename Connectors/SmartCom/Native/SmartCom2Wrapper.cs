...
Project: StockSharp.SmartCom.Native.SmartCom
File: SmartCom2Wrapper.cs
...
namespace StockSharp.SmartCom.Native
{
	...
	/// <summary>
	/// Обертка над SmartCOM 2.X API.
	/// </summary>
	[CLSCompliant(false)]
	public class SmartCom2Wrapper : SmartComWrapper<StServerClass>
	{
		/// <summary>
		/// Создать <see cref="SmartCom2Wrapper"/>.
		/// </summary>
		public SmartCom2Wrapper()
		{
		}
		...
		/// </summary>
		public override bool IsSupportCancelAllOrders => true;

		/// <summary>
		/// Версия обертки.
		/// </summary>
		public override SmartComVersions Version => SmartComVersions.V2;
		...
		{
			SafeGetServer().connect(host, port, login, password);
		}
