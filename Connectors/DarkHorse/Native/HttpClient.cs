...
class HttpClient : BaseLogReceiver
{
	...
	*/
    public async Task<InfoReply> GetInfo(CancellationToken cancellationToken)
    {
        return await MakePublicRequest<InfoReply>("getInfo", cancellationToken);
    }
    #endregion
    ...
    {
        return MakePublicRequest<List<Candle>>($"api/markets/{currency}/candles?resolution={resolution.TotalSeconds}&start_time={GetSecondsFromEpochStart(start)}&end_time={GetSecondsFromEpochStart(end)}", cancellationToken);
    }
	...
	*/
    ...
    public async Task<OrdersReply> GetActiveOrders(CancellationToken cancellationToken)
    {
        return await MakePublicRequest<OrdersReply>("activeOrders", cancellationToken);
    }
