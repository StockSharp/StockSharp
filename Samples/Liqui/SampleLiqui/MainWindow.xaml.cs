namespace SampleLiqui
{
	...
	public partial class MainWindow
	{
		...
		public MainWindow()
		{
			...
			_logManager.Listeners.Add(new FileLogListener { LogDirectory = "StockSharp_Liqui" });
		}
		...
		private void ConnectClick(object sender, RoutedEventArgs e)
		{
			if (!_isConnected)
			{
				...
				{
					// create connector
					Trader = new LiquiTrader();// { LogLevel = LogLevels.Debug };
