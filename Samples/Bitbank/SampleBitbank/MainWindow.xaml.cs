namespace SampleBitbank
{
	...
	public partial class MainWindow
	{
		...
		public MainWindow()
		{
			...
			_logManager.Listeners.Add(new FileLogListener { LogDirectory = "StockSharp_Bitbank" });
		}
		...
		private void ConnectClick(object sender, RoutedEventArgs e)
		{
			if (!_isConnected)
			{
				...
				{
					// create connector
					Trader = new BitbankTrader();// { LogLevel = LogLevels.Debug };
