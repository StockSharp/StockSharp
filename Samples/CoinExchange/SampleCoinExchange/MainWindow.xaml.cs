namespace SampleCoinExchange
{
	...
	public partial class MainWindow
	{
		...
		public CoinExchangeTrader Trader;
		...
		public MainWindow()
		{
			...
			_logManager.Listeners.Add(new FileLogListener { LogDirectory = "StockSharp_CoinExchange" });
		}
		...
		private void ConnectClick(object sender, RoutedEventArgs e)
		{
			if (!_isConnected)
			{
				...
				{
					// create connector
					Trader = new CoinExchangeTrader();// { LogLevel = LogLevels.Debug };
