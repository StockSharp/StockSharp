namespace SampleBitZ
{
	...
	public partial class MainWindow
	{
		...
		public MainWindow()
		{
			...
			_logManager.Listeners.Add(new FileLogListener { LogDirectory = "StockSharp_BitZ" });
		}
		...
		private void ConnectClick(object sender, RoutedEventArgs e)
		{
			if (!_isConnected)
			{
				...
				{
					// create connector
					Trader = new BitZTrader();// { LogLevel = LogLevels.Debug };
