namespace SampleCoinigy
{
	...
	public partial class MainWindow
	{
		...
		public MainWindow()
		{
			...
			_logManager.Listeners.Add(new FileLogListener { LogDirectory = "StockSharp_Coinigy" });
		}
		...
		private void ConnectClick(object sender, RoutedEventArgs e)
		{
			if (!_isConnected)
			{
				...
				{
					// create connector
					Trader = new CoinigyTrader();// { LogLevel = LogLevels.Debug };
				...
				Trader.WebSocketId = WebSocketId.Password;
