...
namespace SampleFxcm
{
	...
	{
		private readonly FxcmTrader _trader;
		...
		public ChartWindow(CandleSeries candleSeries)
		{
			...
			_trader.SubscribeCandles(_candleSeries, tf.Ticks == 1 ? DateTime.Today : DateTime.Now.Subtract(TimeSpan.FromTicks(tf.Ticks * 1000)), DateTimeOffset.MaxValue);
		}
