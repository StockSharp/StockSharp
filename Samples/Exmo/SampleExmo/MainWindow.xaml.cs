namespace SampleExmo
{
	...
	public partial class MainWindow
	{
		...
		public MainWindow()
		{
			...
			_logManager.Listeners.Add(new FileLogListener { LogDirectory = "StockSharp_Exmo" });
		}
		...
		private void ConnectClick(object sender, RoutedEventArgs e)
		{
			if (!_isConnected)
			{
				...
				{
					// create connector
					Trader = new ExmoTrader();// { LogLevel = LogLevels.Debug };
